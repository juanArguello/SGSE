...
<html lang="es">
    ...
    <body>
        <div class="container col-lg-3">
            ...
            <form:form modelAttribute="usuario" action="${loginVar}" method="POST" 
                ...
                <sec:authorize access="isAuthenticated()" url="https://localhost:8443/login.html">
                ...
                <div class="form-group">
                    ...
                    <form:password path="contrasenha" class="form-control" 
                        placeholder="password" required="on" showPassword="true" />
                </div>
                <div class="form-group">
