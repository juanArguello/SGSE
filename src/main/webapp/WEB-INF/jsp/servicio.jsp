    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-4">
                    <div class="card">
                        <div id="form-header" class="card-header bg-primary">
                            <h5 id="form-title" class="card-title text-white">Nuevo Servicio</h5>
                        </div>
                        <div class="card-body">
                            <div class="">
                                <form  id="form-servicio" autocomplete="on" class="needs-validation" novalidate="on">
                                    ...
                                    <!--<div class="form-group">
                                        <label for="planes" 
                                               class="col-form-label">Lista de Planes:</label>
                                        <select id="planes" class="form-control" 
                                                multiple ></select> 
                                        <div id="planes-feedback"></div>
                                    </div>-->
                                    <div class="form-group mt-5" align="right">
                                        <sec:csrfInput/>
                                        <button id="btn-servicio" type="submit" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Agregar</button>
                                        <button id="btn-reset" class="btn btn-secondary btn-sm"><i class="bi bi-eraser-fill"></i> Borrar</button>
                                    </div> 
                                </form> 
                            </div>
                        </div>               
                ...
                <div class="col-sm-8 mb-3">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">
                                <i class="bi bi-table me-2"></i> Administración de Servicios
                            </h5> 
                        </div>
                        <div class="card-body">
        ...
        <!--  modal de lista de planes asociado a un sevicio  -->
        ...
        <div class="position-fixed bottom-0 right-0 p-3" 
            ...
            <div id="servicio-toast" class="toast hide" role="alert" aria-live="assertive" 
                 aria-atomic="true" data-delay="8000" 
        ...
        <script src="<c:out value='${pageContext.request.contextPath}/recursos/js/servicio.js'/>"
